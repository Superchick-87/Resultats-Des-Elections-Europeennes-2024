...
<?php
	...
	<div class="flex">
		<div id="dept'.ddc($phrasesDeps[0][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[4][1],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[1][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[4][2],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[2][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[4][3],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[3][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[4][4],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[4][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[4][5],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[5][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[4][6],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[6][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[4][7],1,',','').'%</p>
...
?>
	...
	<script src="js/landes.js" type="text/javascript"></script>
