...
<?php
	...
	echo '<br/>
		<div id="departement" style="">
			<svg id="entete" viewBox="0 0 640 595">
			</svg>
		</div>
	<br>
	<hr class="separation">
	...
	<div class="flex">
		<div id="dept'.ddc($phrasesDeps[0][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[5][1],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[1][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[5][2],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[2][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[5][3],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[3][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[5][4],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[4][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[5][5],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[5][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[5][6],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[6][0]).'" class="PetitesCartes">
			...
			<p class="chiffre">'.number_format($chiffresDeps[5][7],1,',','').'%</p>
...
?>
	...
	<script src="js/lot-et-garonne.js" type="text/javascript"></script>
