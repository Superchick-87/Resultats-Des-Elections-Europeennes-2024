...
<?php
	...
	echo '<br/>
		<div id="departement" style="">
			<svg id="entete" viewBox="0 0 640 640">
			</svg>
		</div>
	<br>
	<hr class="separation">
	...
	<div class="flex">
		<div id="dept'.ddc($phrasesDeps[0][0]).'" class="PetitesCartes View1">
			...
			<p class="chiffre">'.number_format($chiffresDeps[0][1],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[1][0]).'" class="PetitesCartes View2">
			...
			<p class="chiffre">'.number_format($chiffresDeps[0][2],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[2][0]).'" class="PetitesCartes View3">
			...
			<p class="chiffre">'.number_format($chiffresDeps[0][3],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[3][0]).'" class="PetitesCartes View4">
			...
			<p class="chiffre">'.number_format($chiffresDeps[0][4],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[4][0]).'" class="PetitesCartes View5">
			...
			<p class="chiffre">'.number_format($chiffresDeps[0][5],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[5][0]).'" class="PetitesCartes View6">
			...
			<p class="chiffre">'.number_format($chiffresDeps[0][6],1,',','').'%</p>
		...
		<div id="dept'.ddc($phrasesDeps[6][0]).'" class="PetitesCartes View7">
			...
			<p class="chiffre">'.number_format($chiffresDeps[0][7],1,',','').'%</p>
...
?>
	...
	<script src="js/charente.js" type="text/javascript"></script>
