...
function entete(){
	var promises = [
			d3.json('js/maps/departements/communes-16-charente.geojson'),
 ...
 // PARAMETRES CARTE			
			...
			.range(["#eeeeee","#eeeeee","#404040","#cc2443","#404040","#00c000","#eeeeee","#8D2E88","#bb0000","#eeeeee","#ffeb00","#ffd1dc","#00c000","#00c000","#0066CC","#00c000","#0066CC","#0066CC","#bb0000","#ffd1dc","#ffd1dc","#bb0000","#bb0000","#404040","#404040","#404040","#ffd1dc","#cc2443","#0066CC","#404040","#ffd1dc","#eeeeee","#cc2443","#eeeeee","#00c000","#cc2443","#eeeeee"]);
...
function LaRepubliqueEnMarche(){
 ...
 //LEGENDE
		    ...
		    var svg = d3.select("div#deptBesoinDeurope")
		        .append("svg")
		        .attr("width", width)
		        .attr("height", height)
		        .attr("preserveAspectRatio", "xMinYMin meet")
	        	.attr("viewBox", "-70 -10 480 60")
		        .attr("id",'echelleBesoinDeurope');
...
function PartiSocialiste(){
 ...
 //CARTE
			d3.select('svg#PartiSocialistePlacePublique')
	        	...
	        	.attr("viewBox", "0 0 640 640")
				.append('g')
				.attr('id', 'cartePartiSocialistePlacePublique')
				.selectAll('path')
				.data(data.features)
				.enter()
				.append('path')
 ...
 //LEGENDE
		    ...
		    var svg = d3.select("div#deptPartiSocialistePlacePublique")
		        .append("svg")
		        .attr("width", width)
		        .attr("height", height)
		        .attr("preserveAspectRatio", "xMinYMin meet")
		    ...
		    svg.append("g")
		       .attr("transform", "translate(158, 20)")
		       .attr("id",'graduationPartiSocialistePlacePublique')
		       .call(x_axis);
 ...
 //COLORBAR
			var colors = d3.scaleLinear()
		     ...
		     var legend = svg.append('g')
                .attr('transform', 'translate(40, 10)')
                .attr('id', 'legendPartiSocialistePlacePublique');
