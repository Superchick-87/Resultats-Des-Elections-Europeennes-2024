...
function entete(){
	var promises = [
			d3.json('js/maps/departements/communes-17-charente-maritime.geojson'),
 ...
 // PARAMETRES CARTE			
			...
			.range(["#404040","#cc2443","#404040","#00c000","#ffe207","#0066CC","#ffd1dc","#cc2443","#9E9E9E"]);
...
function PartiSocialiste(){
 ...
 //LEGENDE
		    ...
		    var svg = d3.select("div#deptPartiSocialistePlacePublique")
		        ...
		        .attr("preserveAspectRatio", "xMinYMin meet")
	        	.attr("viewBox", "-70 -10 480 60")
		        .attr("id",'echellePartiSocialistePlacePublique');
